...
def default_data():
    ...
    turtle.setup(width = canvas_witdth, height = canvas_height)
...
def object_display():
    #We definieren een schaal (1 meter is 10 pixels)
    global new_lengte
    global new_breedte
    global new_hoogte
...
# conditionals inside main function
